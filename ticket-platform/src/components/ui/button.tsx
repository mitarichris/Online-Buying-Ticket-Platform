  ...
  ({ className, variant = "primary", size = "md", loading, disabled, children, ...props }, ref) => (
    <button
      ...
      className={cn(
        ...
        {
          "bg-[#D4AF37] text-[#0F172A] hover:bg-[#B8942E] focus:ring-[#D4AF37]": variant === "primary",
          "bg-gray-800 text-white hover:bg-gray-700 focus:ring-gray-500 dark:bg-gray-700 dark:hover:bg-gray-600": variant === "secondary",
          "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-[#D4AF37] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700": variant === "outline",
